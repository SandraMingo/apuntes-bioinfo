...
Es posible conectar varias condiciones mediante el uso de \texttt{and} y \texttt{or}. Para ello, la forma preferida es combinar condiciones individuales con los operadores \&\& para and y || para or.
\begin{lstlisting}
