...
El comando \texttt{sort} \marginpar[\footnotesize sort] \ ordena una entrada por teclado o un fichero alfanuméricamente. Si un fichero está separado en líneas, utiliza el primer caracter de cada línea. A este comando se le puede pasar directamente ficheros o se le puede redireccionar por entrada.
