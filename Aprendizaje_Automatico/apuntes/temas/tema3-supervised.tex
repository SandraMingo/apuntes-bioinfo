...
\item El vector $\vec{x}$ puede tener valores continuos y discretos.
...
\begin{itemize}
\item \textbf{De valor real:} distribución gaussiana
\item \textbf{Binaria}: distribución Bernoulli
\item \textbf{Categórica:} distribución multinoulli
\end{itemize}
