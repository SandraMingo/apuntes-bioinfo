...
\begin{alltt}
\hlcom{## Without logs}
\hlkwd{wilcox.test}\hldef{(dmyc}\hlopt{$}\hldef{myc[}\hlnum{1}\hlopt{:}\hlnum{12}\hldef{], dmyc}\hlopt{$}\hldef{myc[}\hlnum{13}\hlopt{:}\hlnum{24}\hldef{],} \hlkwc{paired} \hldef{=} \hlnum{TRUE}\hldef{)}
\end{alltt}
\begin{verbatim}
## 
## 	Wilcoxon signed rank exact test
...
\end{verbatim}
\begin{alltt}
\hlcom{## After taking logs}
\hlkwd{wilcox.test}\hldef{(}\hlkwd{log}\hldef{(dmyc}\hlopt{$}\hldef{myc[}\hlnum{1}\hlopt{:}\hlnum{12}\hldef{]),} \hlkwd{log}\hldef{(dmyc}\hlopt{$}\hldef{myc[}\hlnum{13}\hlopt{:}\hlnum{24}\hldef{]),} \hlkwc{paired} \hldef{=} \hlnum{TRUE}\hldef{)}
\end{alltt}
\begin{verbatim}
## 
## 	Wilcoxon signed rank exact test
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{numSummary}\hldef{(mit}\hlopt{$}\hldef{activ ,} \hlkwc{groups} \hldef{= mit}\hlopt{$}\hldef{ftraining,} \hlkwc{statistics} \hldef{=} \hlkwd{c}\hldef{(}\hlsng{"mean"}\hldef{,} \hlsng{"sd"}\hldef{))}
\end{alltt}
\begin{verbatim}
##               mean        sd data:n
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{with}\hldef{(mit,} \hlkwd{aggregate}\hldef{(activ,} \hlkwd{list}\hldef{(}\hlkwc{Training} \hldef{= ftraining),}
                     \hlkwa{function}\hldef{(}\hlkwc{x}\hldef{)} \hlkwd{c}\hldef{(}\hlkwc{mean} \hldef{=} \hlkwd{mean}\hldef{(x),}
                                   \hlkwc{sd} \hldef{=} \hlkwd{sd}\hldef{(x),}
                                   \hlkwc{n} \hldef{=} \hlkwd{sum}\hldef{(}\hlopt{!}\hlkwd{is.na}\hldef{(x)))}
                     \hldef{))}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{library}\hldef{(multcomp)} \hlcom{## for glht}
\end{alltt}


{\ttfamily\noindent\itshape\color{messagecolor}{\#\# Cargando paquete requerido: mvtnorm}}

{\ttfamily\noindent\itshape\color{messagecolor}{\#\# Cargando paquete requerido: survival}}

{\ttfamily\noindent\itshape\color{messagecolor}{\#\# Cargando paquete requerido: TH.data}}

{\ttfamily\noindent\itshape\color{messagecolor}{\#\# Cargando paquete requerido: MASS}}

{\ttfamily\noindent\itshape\color{messagecolor}{\#\# \\\#\# Adjuntando el paquete: 'TH.data'}}
...
\end{alltt}
\end{kframe}\begin{figure}
\includegraphics[width=\maxwidth]{figure/tukey1-1} \caption[Plot of pairwise differences with Tukey contrasts]{Plot of pairwise differences with Tukey contrasts}\label{fig:tukey1}
\end{figure}
