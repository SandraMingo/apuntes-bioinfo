...
Cuando se trabaja con alineadores, el proceso suele generar un perfil con picos que representan las bases detectadas, a cada uno de los cuales se le asigna el nombre de base. El alineador produce un archivo final dividido en campos que contiene: (i) el nombre de la @secuencia y (ii) la secuencia de bases asignadas, (iii) un + con posibles metadatos y (iv) la calidad de lectura de cada base en un formato codificado llamado \textbf{Phred33}, que usa caracteres ASCII para representar los valores de calidad.
...
– “>” Nombre de la secuencia y descripción opcional
– Línea(s) con la secuencia completa
...
Una vez mapeadas las lecturas al genoma de referencia, se puecen obtener los distintos estados:
\begin{itemize}
...
\item \textbf{Lecturas con mapeo múltiple (multimappers):} Ha mapeado varias posiciones. Se distinguen mapeos primarios y secundarios en función de la puntuación de mapeo. Se puede concatener con técnicas heurísticas.
\end{itemize}
